...
![[organigrama-icann-iana-ietf-rirs-isps.png]]

> [!important] Organismos clave
...
El organismo IANA distribuye las IPs entre los RIRs y estos, a su vez, a los **ISP** (Internet Service Provider), que las entregan a los usuarios finales.
...
| Nivel (Tier) | Significado | Ejemplos |
| --- | --- | --- |
| Tier 1 | ISP con alcance global, no paga tránsito a nadie, solo hace **peering**. | Level 3/Lumen, NTT, Telia, AT&T, GTT, Tata, Cogent, Verizon |
| Tier 2 | ISP regional que paga a un Tier 1 para conectarse al resto de Internet. | Internexa, IFX, Silica Networks |
| Tier 3 | ISP local o de acceso final. | Telecom Argentina, Claro, Telecentro, etc. |
