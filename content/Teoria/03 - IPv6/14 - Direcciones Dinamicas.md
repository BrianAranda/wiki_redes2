...
> La obtención de direcciones de capa 3, y la relación de direcciones de capa 3 con capa 2 (MAC), están relacionadas; es por eso que este tema de "Direcciones Dinámicas" y "[[13 - Neighbor Discovery ND|Neighbor Discovery ND]]", el tema anterior, están íntimamente relacionados.
...
La parte de IPv6 que corresponde a la interfase de red se genera de manera automática usando [[09 - Unicast#1) EUI-64|EUI-64]] o de manera aleatoria dependiendo de la configuración del Sistema Operativo.
...
---
**Volver a:** [[13 - Neighbor Discovery ND|Neighbor Discovery ND]]

**Continuar a:** [[15 - ICMPv6|ICMPv6]]
